        ...
        <div className='flex w-full h-full'>
            <div className="p-4 w-full" onClick={() => {
                ...
                <div
                    ...
                    className={cn("bg-background max-w-[920px] h-full m-auto rounded-xl flex flex-col flex-grow items-center justify-start flex-1 overflow-y-auto", droppable.isOver && "ring-2 ring-primary ring-inset")}>
                    ...
                    {droppable.isOver && elements.length === 0 && (
                        <div className='p-4 w-full'>
                            <div className="h-[128px] rounded-md bg-primary/20"></div>
                        </div>
                    )}
                    {elements.length > 0 && (
            ...
            <div ref={bottomHalf.setNodeRef} className="absolute w-full bottom-0 h-1/2 rounded-b-md" />
            {
                mouseIsOver && (
                    ...
                    <div className="absolute right-0 h-full">
                        <Button 
                            className='flex justify-center h-full border rounded-md rounded-l-none bg-red-500 items-center'
                            variant={'outline'}
                            onClick={(e) => {
                                e.stopPropagation();
